...
*Note: This consumes extra I/O and disk space during the operation.*
...
*Tip: Combine this with `maintenance_scheduler.sql` to analyze which maintenance windows usually have the lowest load.*
