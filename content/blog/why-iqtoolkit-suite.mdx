...
excerpt: "After more than 10 years as a database professional, I built iqtoolkit to solve one problem: freeing DBAs from manual correlation hell so we can focus on what we actually want to do—architecture, automation, and engineering."
tags:
  [
    "philosophy",
    "dba",
...
_(This reflects v0.2.2 capabilities. Full metrics/logs correlation coming in 2026.)_
